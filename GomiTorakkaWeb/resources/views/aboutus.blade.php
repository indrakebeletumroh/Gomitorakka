    ...
    <main class="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <section class="text-center mb-16">
            ...
            <p class="text-lg opacity-80 max-w-3xl mx-auto">
                We believe a cleaner future starts with smart, simple steps. GomiTorakka is here to reshape how we deal with waste—using smart technology and a spirit of sustainability to build a healthier planet.
            </p>
        </section>
        ...
        <section class="mb-16">
            <div class="flex flex-col md:flex-row gap-8 items-center">
                ...
                <div class="md:w-1/2">
                    ...
                    <p class="mb-4">
                        GomiTorakka was founded with a clear purpose: to make waste management easier, more efficient, and environmentally responsible. We combine Internet of Things (IoT) technology with data insights to help communities understand and manage their waste more wisely.
                    </p>
                    <p>
                       Through our smart bins and tracking systems, we help prevent overflow, optimize collection routes, and provide valuable insights for more sustainable waste management practices.
                    </p>
                </div>
            </div>
        </section>
